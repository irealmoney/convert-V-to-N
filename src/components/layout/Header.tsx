            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                ...
                <div className=" inset-y-0 right-0 flex justify-between items-center pr-2  sm:static sm:inset-auto  sm:pr-0">
                    ...
                    <div className='mx-1 px-1'>
                        <Link className='flex flex-row items-center border-2 font-bold text-sm border-[#F15A22] rounded-xl px-2 py-1 text-[#F15A22] duration-400 hover:bg-[#F15A22] hover:text-white' href={'/auth/user'}>
                        ورود - عضویت   <TbLogin className='size-5'/>
                        </Link>
                    </div>
                    ):(
